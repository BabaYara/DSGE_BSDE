...
% Bibliography: prefer bibtex backend here to avoid environment-specific biber mismatches
\usepackage[backend=bibtex,style=authoryear,maxcitenames=2,maxbibnames=99,doi=false,isbn=false,url=false]{biblatex}
