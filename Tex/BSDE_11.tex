...
theorem ll_mono_discrete (q : iota ? R) (P : R ? R)
  (w1 w2 : iota ? R) (hP : Antitone P) :
  sum i, (P (sum j, q j * w1 j) - P (sum j, q j * w2 j)) * q i * (w1 i - w2 i)
    <= 0 := by
  classical
  set Y1 : R := sum j, q j * w1 j
  set Y2 : R := sum j, q j * w2 j
...
theorem antitone_implies_cross_product_nonpos (P : R ? R) (hP : Antitone P) (Y1 Y2 : R) :
